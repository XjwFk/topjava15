...
public class UserMealsUtil {
    public static void main(String[] args) {
        ...
        List<UserMealWithExceed> list = getFilteredWithExceededStream2(mealList, LocalTime.of(7, 0), LocalTime.of(12,0), 2000);
...
//        .toLocalTime();
    ...
    public static List<UserMealWithExceed> getFilteredWithExceededStream(List<UserMeal> mealList, LocalTime startTime, LocalTime endTime, int caloriesPerDay) {
        ...
        return mealList.stream()
                ...
                .map(userMeal -> new UserMealWithExceed(userMeal.getDateTime(), userMeal.getDescription(),
                        userMeal.getCalories(), caloriesPerDay < map.get(userMeal.getDateTime().toLocalDate())))
    ...
    public static List<UserMealWithExceed> getFilteredWithExceededStream2(List<UserMeal> mealList, LocalTime startTime, LocalTime endTime, int caloriesPerDay) {
        Map<LocalDate, Integer> map = mealList.stream().collect(Collectors.groupingBy(o -> o.getDateTime().toLocalDate(), Collectors.summingInt(UserMeal::getCalories)));
